...
import 'package:online_course_app_ui/widget/navbar_item.dart';
import 'package:online_course_app_ui/widget/subject_item.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          "Coursera",
                          style: GoogleFonts.revalia(fontSize: 16.sp, color: Colors.red.shade900),
                        ),
                        SizedBox(
                          height: 4.h,
                        ),
      ...
      floatingActionButton: Container(
        ...
        decoration: BoxDecoration(
            color: Color(0x999a8d8d), borderRadius: BorderRadius.circular(23)),
        child: Row(
